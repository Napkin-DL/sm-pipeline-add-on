...
def run():
    ...
    for e in range(args.epochs):
        ...
        #######  model/output/net.pth    ##
        
#         copy_tree("dl_utils", os.path.join(os.environ['SM_MODEL_DIR'], "code"))
#         copy_tree(output_path, os.path.join(os.environ['SM_MODEL_DIR'],"output"))

        copy_tree("dl_utils", os.environ['SM_MODEL_DIR'])
        copy_tree(output_path, os.environ['SM_MODEL_DIR'])
        ###################################
